...
import com.emperador.springboot.app.entity.Factura;
import com.emperador.springboot.app.entity.ItemFactura;
import com.emperador.springboot.app.entity.Producto;
...
public class FacturaController {
	...
	public String guardar(@Valid Factura factura, BindingResult result, Model model,
		...
		if (result.hasErrors()) {
			model.addAttribute("título", "Crear Factura");
			return "factura/form";
		}
	...
	public String eliminar(@PathVariable(value = "id") Long id, RedirectAttributes flash) {
		...
		flash.addFlashAttribute("error", "La factura no existe en la BDD!");
